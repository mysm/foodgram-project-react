...
from .serializers import (
    FavoriteRecipeSerializer, IngredientSerializer, RecipeEditSerializer,
    RecipeReadSerializer, SetPasswordSerializer, ShoppingCartSerializer,
    SubscribeSerializer, TagSerializer, UserCreateSerializer,
    UserListSerializer,
)
...
class FavoriteRecipeViewSet(CreateDestroyViewSet):
    ...
    def delete(self, request, recipe_id):
        ...
        if (
            not request_user.favorite.select_related("favorite_recipe")
...
class ShoppingCartViewSet(CreateDestroyViewSet):
    ...
    def delete(self, request, recipe_id):
        request_user = request.user
        if (
            not request_user.shopping_cart.select_related("recipe")
